  ...
  <div>
    <b-card id="cardLogin" class="scale-in-bl">
      <b-form @submit="onSubmit" @reset="onReset" v-if="show" id="formLogin">
        ...
        <h2 class="text-center mb-4">Weclome back!</h2>
        ...
        <span class="text-center mb-4 other-account">Login with your account</span>
        ...
        <div class="d-flex justify-content-between flex-wrap">
          <b-form-checkbox value="remember" class="remember">Remember</b-form-checkbox>
          <div>
            <router-link to="/recover" class="forgotPassword">Forgot password ?</router-link>
          </div>
        </div>
        ...
        <div class="d-flex justify-content-center mt-3">
          <a href="#">
            <fa :icon="['fas', 'arrow-right']" class="arrow-btn" />
          </a>
        </div>

        <div class="d-flex justify-content-center flex-wrap mt-4 register">
          <span class="mr-2">Don't have an account yet ?</span>
          <router-link to="/register" class="createAccount">Create an account</router-link>
        </div>
      </b-form>
    </b-card>
  </div>
